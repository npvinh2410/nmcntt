...
return [
    ...
    'set_focus_description' => 'Click the image to set the FocusPoint.',
    ...
    'share_title' => 'Share item(s)',
    'share_to' => 'Share to',
    'do_not_share' => 'Do not share these files',
    'share_everyone' => 'Everyone',
    'share_to_specific_users' => 'Specific users',
    'up_level' => 'Up one level',
    'please_select_user' => 'Please select users',
    'upload_progress' => 'Upload progress',

    'name_reserved' => 'The name is reserved',
    'folder_created' => 'Folder is created successfully!',
    'invalid_share' => 'Share is not valid!',
    ...
    'share_success' => 'Shared selected item(s) successfully!',
    'un_share_success' => 'Remove share selected item(s) successfully!',
    'remove_share_success' => 'Remove share selected item(s) successfully!',
    'set_focus_success' => 'Set focus point successfully!',
    ...
    'javascript' => [
        ...
        'no_item' => [
            ...
            'shared' => [
                ...
                'message' => 'Any files in shared place will be visible to people that you shared',
            ],
            'shared_with_me' => [
                'icon' => 'fa fa-share-alt',
                'title' => 'You have not received anything from others',
