        ...
        <div class="m-portlet">
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <input class="form-control m-input" type="text" value="{{ $menu->the_name() }}" id="name" name="name" required>
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-10">
                        <select class="form-control m-input" id="position" name="position">
                            <option value="{{$menu->position}}">{{$menu->position}}</option>
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="dd" id="nestable">
                                <ol id="h-menu" class="dd-list">
                                    {!! nestable_render_menu($menu->data) !!}
                                </ol>
                            </div>
                        </div>
                    </div>
...
@section('custom_js')
    ...
    <script type="text/javascript">
        ...
        function update_link()
        {
            ...
            console.log($("#update_link_url").val());
