...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ route('clients.update', ['id' =>$user->id]) }}">
                <div class="m-portlet">
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group @if ($errors->has('name')) has-danger @endif row">
                            ...
                            <div class="col-10">
                                <input class="form-control m-input" type="text" value="{{ $user->client->name }}" id="name" name="name" required>
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group m-form__group @if ($errors->has('phone')) has-danger @endif row">
                            ...
                            <div class="col-10">
                                <input class="form-control m-input" type="text" value="{{ $user->client->phone }}" id="phone" name="phone" required>
                                @if ($errors->has('phone'))
                                    <div class="form-control-feedback">
                                        {{ $errors->first('phone') }}
                                    </div>
                        ...
                        <div class="form-group m-form__group @if ($errors->has('address')) has-danger @endif row">
                            ...
                            <div class="col-10">
                                <input class="form-control m-input" type="text" value="{{ $user->client->address }}" id="address" name="address">
