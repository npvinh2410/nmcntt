            ...
            <div class="col-md-3">
                <div class="m-portlet">
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <input type="hidden" value="" id="main_cat" name="main_cat">
                            {!! render_cat('category') !!}
                        </div>
                ...
                <div class="m-portlet m--margin-top-35">
                    ...
                    <div class="m-portlet__body row">
                        ...
                        <a href="#" class="btn_gallery btn btn-link">Set featured image</a>
                        <a href="#" class="btn_clear_gallery btn btn-link btn-link-remove hidden">Remove</a>
                    </div>
                </div>
            </div>
        </div>
